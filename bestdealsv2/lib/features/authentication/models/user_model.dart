import 'package:bestdealsv2/utils/formatters/formatter.dart';
...
class UserModel {
  ...
  // static functions to generate a username from the fullname
  ...
  /// convert model to json structure for stroing data in firebase
  ...
  /// Factory method to create a usermodel from a firebase documemt snapshot.
